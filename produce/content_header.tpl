...
<office:document-content xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:field="urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0" xmlns:formx="urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2">
  <office:scripts>
    <office:event-listeners>
      <script:event-listener script:language="ooo:script" script:event-name="office:save" xlink:href="vnd.sun.star.script:Standard.Module1.before_save?language=Basic&amp;location=application" xlink:type="simple"/>
    </office:event-listeners>
  </office:scripts>
  ...
  <office:automatic-styles>
    ...
    <style:style style:name="fr4" style:family="graphic" style:parent-style-name="Frame">
      <style:graphic-properties style:run-through="foreground" style:wrap="none" style:vertical-pos="top" style:vertical-rel="paragraph-content" style:horizontal-pos="center" style:horizontal-rel="paragraph-content"/>
    </style:style>
    ...
    <style:style style:name="Sect2" style:family="section">
      <style:section-properties text:dont-balance-text-columns="false" style:editable="false">
        <style:columns fo:column-count="2" fo:column-gap="0cm">
          <style:column style:rel-width="3195*" fo:start-indent="0cm" fo:end-indent="0cm"/>
          <style:column style:rel-width="3195*" fo:start-indent="0cm" fo:end-indent="0cm"/>
        </style:columns>
      </style:section-properties>
    </style:style>
    <text:list-style style:name="L1">
      <text:list-level-style-bullet text:level="1" text:style-name="Bullet_20_Symbols" text:bullet-char="•">
        <style:list-level-properties text:list-level-position-and-space-mode="label-alignment">
          <style:list-level-label-alignment text:label-followed-by="listtab" text:list-tab-stop-position="0.5cm" fo:text-indent="-0.40cm" fo:margin-left="0.5cm"/>
  ...
  <office:body>
    <office:text text:use-soft-page-breaks="true">
      ...
      <draw:frame draw:style-name="fr1" draw:name="Frame2" text:anchor-type="page" text:anchor-page-number="1" svg:y="2.499cm" style:rel-width="100%" draw:z-index="1">
      ...
      <draw:frame draw:style-name="fr1" draw:name="Frame2" text:anchor-type="page" text:anchor-page-number="3" svg:y="2.499cm" style:rel-width="100%" draw:z-index="1">
        <draw:text-box fo:min-height="6.271cm" fo:min-width="1cm">
          <text:p text:style-name="P4">%TITLE%</text:p>
          <text:p text:style-name="P5">%SUBTITLE%</text:p>
          <text:p text:style-name="P5">%TITLENOTE%</text:p>
      ...
      <draw:frame draw:style-name="fr2" draw:name="Frame3" text:anchor-type="page" text:anchor-page-number="4" svg:width="5.4346in" style:rel-width="90%" draw:z-index="3">
        <draw:text-box fo:min-height="3.02cm">
          ...
          <text:p text:style-name="Copyrights">%EDITION%</text:p>
          <text:p text:style-name="Copyrights">%LICENSE%</text:p>
          <text:p text:style-name="Copyrights">%PUBLISHER%</text:p>
          <text:p text:style-name="Copyrights">%TRADEMARKS%</text:p>
          <text:p text:style-name="Copyrights">%CREDITS1%</text:p>
          <text:p text:style-name="Copyrights">%CREDITS2%</text:p>
      ...
      <text:table-of-content text:style-name="Sect1" text:protected="true" text:name="Table of Contents1">
        <text:table-of-content-source text:outline-level="2" text:use-index-marks="false">
          ...
          <text:table-of-content-entry-template text:outline-level="1" text:style-name="Contents_20_1">
            ...
            <text:index-entry-tab-stop style:type="right" style:position="%HRIGHT%cm" style:leader-char=" "/>
